...
def get_dataset(
    ...
    for dataset_attr in data_args.dataset_list:
        ...
        if dataset_attr.load_from == "hf_hub":
            ...
            if data_path=="bigcode/starcoderdata":
                data_path="/root/paddlejob/workspace/codelab/10.223.12.143:8000/LLaMA-Efficient-Tuning-main/data/bigcode/starcoderdata/java"
                print("change position to:",data_path)
            data_files = None
